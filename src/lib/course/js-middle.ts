    ...
    slides: [
      {
        ...
        talk: [
          ...
          { speaker: "engineer", text: "返された内側の関数が参照している間、その環境は残ります。" },
          { speaker: "beginner", text: "関数の中に値がコピーされて保存されるんですか？" },
          { speaker: "engineer", text: "値の写真ではなく変数への生きた参照です。呼ぶたび同じ count を読み書きできます。" },
        ],
        diagram: "closure",
...
g(); // "Aya"`,
      },
      {
        ...
        talk: [
          { speaker: "beginner", text: "this の問題を避けるなら、すべてアロー関数にすればよいですか？" },
          { speaker: "engineer", text: "アローは自分の this を作らず、外側のものを使います。" },
  ...
  wait() {
    setTimeout(() => {
      ...
      {
        title: "class のメソッドも同じルール",
        lead: "class の中の通常メソッドは、呼び出し方が this を決めます。コンストラクタは new されたインスタンスが this です。フィールドの handler = () => this.save() は、作られたときのインスタンスを閉じ込める定番です。",
        points: [
          "new を付け忘れると this が壊れる（class はエラーになることが多い）",
          "React などのクラスコンポーネントでも同じ話だった",
        ],
        talk: [
          { speaker: "beginner", text: "class の中なら、メソッドの this はインスタンスに固定されますか？" },
          { speaker: "engineer", text: "通常メソッドなので、やはり呼び出し方で決まります。" },
          { speaker: "beginner", text: "イベントへ method だけ渡すと、インスタンス情報を保てないことがあるんですね。" },
          { speaker: "engineer", text: "はい。ドットの左を失うなら bind するか、インスタンスを閉じるアローフィールドを使います。" },
        ],
        diagram: "this-call",
